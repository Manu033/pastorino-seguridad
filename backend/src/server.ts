...
import { productosCompuestosRouter } from "./routes/productosCompuestos.js";
import { productosAccesoriosAutomaticosRouter } from "./routes/productosAccesoriosAutomaticos.js";
...
app.use("/productos-accesorios-automaticos", productosAccesoriosAutomaticosRouter);
app.use("/productos-compuestos", productosCompuestosRouter);
